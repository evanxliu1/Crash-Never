"""
yolo_class_frequency_report.py

Scans YOLO detection JSONs to compute and report class frequencies per video and overall.

- Input: Root directory of YOLO detection JSONs
- Output: class_frequency_report.txt (overall and per-video class counts)
- Usage: python yolo_class_frequency_report.py --detections_root <detections_dir> [--output_path <report.txt>]
- Dependencies: tqdm
"""
